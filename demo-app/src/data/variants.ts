...
export const variants: VariantConfig[] = [
  ...
  },
  {
    ...
    category: 'placeholder-blur',
    description: 'Pixel grid smoothed with CSS blur (12px).',
    pluginChain: ['pixels', 'blur', 'svgo', 'data-uri'],
    resultFileType: 'svg',
  ...
  },
  {
    ...
    category: 'placeholder-blur',
    description: 'Delaunay triangulation smoothed with CSS blur (20px).',
    pluginChain: ['triangle', 'blur(20)', 'svgo', 'data-uri'],
    resultFileType: 'svg',
  ...
  {
    name: 'blur-legacy',
    title: 'SVG Blur (Plugin)',
    category: 'blur-test',
    description: 'sqip-plugin-blur with legacyBlur: adds an SVG <feGaussianBlur> filter element.',
  ...
  },
  {
    ...
    category: 'blur-test',
    description: 'sqip-plugin-blur default: applies CSS filter:blur() inside the SVG at build time.',
    pluginChain: ['primitive', 'blur', 'svgo', 'data-uri'],
    resultFileType: 'svg',
  ...
  },
  {
    ...
    category: 'blur-test',
    description: 'No blur plugin — raw CSS filter:blur() applied on the <img> element by the browser.',
    pluginChain: ['primitive', 'svgo', 'data-uri'],
    resultFileType: 'svg',
