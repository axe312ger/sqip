...
# [1.0.0-beta.2](https://github.com/axe312ger/sqip/compare/sqip-plugin-pixels@1.0.0-alpha.53...sqip-plugin-pixels@1.0.0-beta.2) (2026-03-03)
...
- sqip now can naively detect the image background color and the pixels plugin supports setting background color which will be handled as transparent pixels ([f4b7748](https://github.com/axe312ger/sqip/commit/f4b774859591390be3e80c6f3f8b0ec062af4716))
